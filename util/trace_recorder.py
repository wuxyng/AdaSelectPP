        ...
        **_ignored: Any,
        ...
        for k in sorted(interest, key=_sort_key):
            ...
            row = {
                ...
                "candidate_count_raw": wdcg_stats.get("candidate_count_raw", ""),
                "appearing_count": wdcg_stats.get("appearing_count", ""),
                "candidate_topk": wdcg_stats.get("candidate_topk", ""),
                "optimizer_ratio": wdcg_stats.get("optimizer_ratio", ""),
                "eval_budget_formula": wdcg_stats.get("eval_budget_formula", ""),
                "eval_budget": wdcg_stats.get("eval_budget", ""),
                "evaluated_count": wdcg_stats.get("evaluated_count", ""),
                "budgeted_out_count": wdcg_stats.get("budgeted_out_count", ""),
                "width1_appearing_count": wdcg_stats.get("width1_appearing_count", ""),
                "width2_appearing_count": wdcg_stats.get("width2_appearing_count", ""),
                "width1_evaluated_count": wdcg_stats.get("width1_evaluated_count", ""),
                "width2_evaluated_count": wdcg_stats.get("width2_evaluated_count", ""),
                "width2_eval_coverage_ratio": wdcg_stats.get("width2_eval_coverage_ratio", ""),
                ...
                "materialization_gap_eval_gap": wdcg_stats.get("materialization_gap_eval_gap", wdcg_stats.get("materialization_gap_eval_gap_count", "")),
